  ...
  return (
    ...
    <div className='mx-auto max-w-6xl sm:px-6 lg:px-8 flex text-white font-bold'>
        ...
        <div className='flex w-3/4 gap-4 justify-end items-end pb-5'>
            <a className={`border-2 border-blackCPN-900 ${menu == "inicio" ? "bg-orangeCPN-600" : ""} w-44 flex items-center justify-center rounded-full py-1.5 cursor-pointer`}>INICIO</a>
